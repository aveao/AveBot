...
async def on_message(message):
    try:
        if message.content.startswith('>') or message.content.startswith('!') or message.content.lower().startswith('ok') and message.author.id not in get_ban_list():
        ...
        elif message.content.startswith('>') or message.content.startswith('!') or message.content.lower().startswith('ok'):
