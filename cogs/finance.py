...
class Finance:
    ...
    async def chart(self, ctx, ticker: str):
        ...
        image_link = f"https://finviz.com/chart.ashx?t={ticker.upper()}&ty=c&ta=1&p=d&s=l&cacheinval={time.time()}"
    ...
    async def btc(self, ctx):
        ...
        try:
            ...
            link = f"https://bitcoincharts.com/charts/chart.png?width=600&m=bitstampUSD&r=30&t=S&v=1&cacheinval={time.time()}"
